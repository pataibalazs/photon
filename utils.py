...
openai.api_key = "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"
...
def callGPT(input):
    ...
    functions = [
        {
            "name": "write_post",
            "description": "Shows the prompt1, prompt2, prompt3, prompt4, prompt5, prompt6, prompt7, prompt8, prompt9, prompt10, prompt11, prompt12, prompt13, prompt14, prompt15 of some the input food: "+"input",
            "parameters": {
                "type": "object",
                "properties": {
                    "prompt1": {
